...
explicit execute_string(std::string const &s,
                        qx::Operations operations = qx::default_operations::defaultOperations,
...
std::unique_ptr<qx::core::MixedStateBase>
explict execute_file(std::string const &filePath,
                     qx::Operations operations = qx::default_operations::defaultOperations,
                     std::size_t iterations = 1,
                     std::optional<std::uint_fast64_t> seed = std::nullopt) {
